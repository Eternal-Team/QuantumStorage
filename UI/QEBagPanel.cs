...
using QEChest = QuantumStorage.TileEntities.QEChest;

namespace QuantumStorage.UI;

public class QEBagPanel : BaseUIPanel<QEBag>, IItemStorageUI
{
	...
	public QEBagPanel(QEBag chest) : base(chest)
	{
	...
	public string GetCursorTexture(Item item) => QuantumStorage.TexturePath + "Items/QEBag";
}